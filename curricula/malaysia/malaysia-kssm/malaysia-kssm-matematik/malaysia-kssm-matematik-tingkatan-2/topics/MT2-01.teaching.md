...
## Prerequisites Check
- Students can confidently represent unknowns with variables (MT1-05 Ungkapan Algebra).
- Comfort with basic integer operations and identifying simple arithmetic multiples and intervals (MT1-01 Nombor Nisbah).
- The ability to substitute numbers into an algebraic expression and solve it (MT1-05 Ungkapan Algebra).
