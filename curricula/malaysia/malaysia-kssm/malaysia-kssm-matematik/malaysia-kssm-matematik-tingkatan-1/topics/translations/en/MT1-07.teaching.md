...
## Prerequisites Check
- A solid grasp of the number line, specifically understanding that values increase as you move to the right and decrease to the left (MT1-01 Nombor Nisbah).
- A strong foundation in basic arithmetic operations involving integers (MT1-01 Nombor Nisbah).
- Familiarity with the equation balancing process (MT1-06 Persamaan Linear), because solving linear inequalities uses an almost identical algebraic isolation process.
