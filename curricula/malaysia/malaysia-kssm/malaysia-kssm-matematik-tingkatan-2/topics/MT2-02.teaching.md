...
## Prerequisites Check
- Native fluency in collecting like terms and working with linear expressions (MT1-05 Ungkapan Algebra).
- Ability to solve basic linear equations and verify results (MT1-06 Persamaan Linear).
- Strong command of directed numbers and integer operations, especially negative signs (MT1-01 Nombor Nisbah).
